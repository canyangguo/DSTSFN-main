...
def main():
    ...
    adj_mx = np.load('data/shenzhen/matrix.npy')#get_adj_matrix('data/chengdu/matrix.csv', 524)
    dataloader = generate_data('data/shenzhen/dataset.npy', args.batch_size, args.batch_size)
