...
''' #random seed spend massive time
seed = 0
random.seed(seed)
np.random.seed(seed)
...
def main():
    ...
    adj_mx = get_adj_matrix('data/PEMS07/PEMS07.csv', 883)
    dataloader = generate_data('data/PEMS07/PEMS07.npz', args.batch_size, args.batch_size)
