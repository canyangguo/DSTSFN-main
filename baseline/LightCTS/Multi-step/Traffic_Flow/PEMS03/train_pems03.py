...
def main():
    ...
    adj_mx = get_adj_matrix('data/PEMS03/PEMS03.csv', 358, id_filename="data/PEMS03/PEMS03.txt")
    dataloader = generate_data('data/PEMS03/PEMS03.npz', args.batch_size, args.batch_size)
