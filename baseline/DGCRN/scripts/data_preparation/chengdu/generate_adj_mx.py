...
def generate_adj_chengdu():
    distance_df_filename, num_of_vertices = "datasets/raw_data/chengdu/matrix.npy", 524
    ...
    with open("datasets/raw_data/chengdu/adj_chengdu.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/chengdu/adj_chengdu_distance.pkl", "wb") as f:
