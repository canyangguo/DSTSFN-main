...
def generate_adj_shenzhen():
    distance_df_filename, num_of_vertices = "datasets/raw_data/shenzhen/matrix.npy", 627
    ...
    with open("datasets/raw_data/shenzhen/adj_shenzhen.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/shenzhen/adj_shenzhen_distance.pkl", "wb") as f:
