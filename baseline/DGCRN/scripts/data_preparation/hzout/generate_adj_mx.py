...
def generate_adj_hzout():
    distance_df_filename, num_of_vertices = "datasets/raw_data/hzout/hzout.csv", 80
    ...
    with open("datasets/raw_data/hzout/adj_hzout.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/hzout/adj_hzout_distance.pkl", "wb") as f:
