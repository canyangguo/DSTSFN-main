...
def generate_adj_hangzhou():
    distance_df_filename, num_of_vertices = "datasets/raw_data/hangzhou/matrix.npy", 80
    ...
    with open("datasets/raw_data/hangzhou/adj_hangzhou.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/hangzhou/adj_hangzhou_distance.pkl", "wb") as f:
