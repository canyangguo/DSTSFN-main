...
def generate_adj_PTL():
    distance_df_filename, num_of_vertices = "datasets/raw_data/PTL/matrix.npy", 1156
    ...
    with open("datasets/raw_data/PTL/adj_PTL.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/PTL/adj_PTL_distance.pkl", "wb") as f:
