...
def load_adj(adj_dtw_filename, graph_signal_matrix_filename, adj_filename, num_of_vertices, id_filename, model_name):
    ...
    adj_mx = construct_adj_fusion(None, adj_gm, adj_dtw, 4, model_name)
