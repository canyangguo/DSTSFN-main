refer to https://github.com/BUAABIGSCity/PDFormer
...
```shell
python run_model.py --task traffic_state_pred --model PDFormer --source PeMS08 --train true --exp_id full_dtw --cuda 0
```
