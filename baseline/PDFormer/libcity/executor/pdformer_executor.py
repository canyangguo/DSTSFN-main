...
class PDFormerExecutor(TrafficStateExecutor):
    ...
    def train(self, train_dataloader, eval_dataloader):
        ...
        print(self._epoch_num, self.epochs)
    ...
    def get_sparse_data(self, data):

        x = data['X'] 

        missing_rate = torch.rand(x.shape[0])# * missing_rate
    ...
    def _train_epoch(self, train_dataloader, epoch_idx, batches_seen=None, loss_func=None):
        ...
        for batch in train_dataloader:
            ...
            #batch = self.get_sparse_data(batch)
