...
class DataEmbedding(nn.Module):
    ...
    def forward(self, x, lap_mx):
        ...
        #print(origin_x[:, :, :, self.feature_dim] * self.minute_size)
        if self.add_time_in_day:
...
class PDFormer(AbstractTrafficStateModel):
    def __init__(self, config, data_feature):
        ...
        print(self.task_level)
        print('max_epoch: ', self.max_epoch, 'num_batches: ',self.num_batches, 'world_size: ',self.world_size)
        print('step_size: ', self.step_size, 'output_window: ', self.output_window)
