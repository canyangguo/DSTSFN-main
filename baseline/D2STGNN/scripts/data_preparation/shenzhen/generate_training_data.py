...
from generate_adj_mx import generate_adj_shenzhen
...
def generate_data(args: argparse.Namespace):
    ...
    train_num_short = round(num_samples * train_ratio)#3*144#
    valid_num_short = round(num_samples * valid_ratio)
    test_num_short = round(num_samples * valid_ratio) #num_samples - train_num_short - valid_num_short
    ...
    valid_index = index_list[round(num_samples * train_ratio): round(num_samples * train_ratio) + valid_num_short] #index_list[:train_num_short]#
    test_index = index_list[round(num_samples * train_ratio) + valid_num_short: ]
