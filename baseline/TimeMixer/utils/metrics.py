...
def metric(pred, true):
    mae = masked_mae_np(true, pred, 0)
    rmse = masked_mse_np(true, pred, 0) ** 0.5
    mape = masked_mape_np(true, pred, 0)
    smape = masked_smape_np(true, pred, 0)
    wmape = masked_wmape_np(true, pred, 0)
    msis = masked_msis_np(true, pred, 0)
